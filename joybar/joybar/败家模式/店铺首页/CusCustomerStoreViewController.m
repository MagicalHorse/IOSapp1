//
//  CusCustomerStoreViewController.m
//  joybar
//
//  Created by 123 on 15/7/2.
...
@interface CusCustomerStoreViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, CHTCollectionViewDelegateWaterfallLayout,UIScrollViewDelegate>
...
@implementation CusCustomerStoreViewController
...
- (void)addFooter
{
    __weak CusCustomerStoreViewController *vc = self;
    // 添加上拉刷新尾部控件
...
//    self.orangeLine = [[UIView alloc] init];
//    self.orangeLine.center = CGPointMake(kScreenWidth/2, contentView.height-2);
//    self.orangeLine.bounds = CGRectMake(0, 0, kScreenWidth/3-40, 2);
